...
func evalBlockStatement(statements []ast.Statement, env *object.Environment) object.Object {
	...
	for _, statement := range statements {
		...
		if result != nil {
			rt := result.Type()
			if rt == object.RETURN_VALUE || rt == object.ERROR_OBJ {
				return result
			}
		}
	}
...
func evalIndexExpression(left, index object.Object) object.Object {
	...
	case left.Type() == object.ARRAY_OBJ && index.Type() == object.INTEGER_OBJECT:
		return evalArrayIndexExpresson(left, index)
	case left.Type() == object.HASH_OBJ:
		return evalHashIndexExpresson(left, index)
	default:
		return newError("index operator not supported: %s", left.Type())
	}
}

func evalArrayIndexExpresson(left, index object.Object) object.Object {
...
func evalHashIndexExpresson(left, index object.Object) object.Object {
...
func evalHashLiteral(h *ast.HashLiteral, env *object.Environment) object.Object {
	...
	for keyNode, valNode := range h.Pairs {
